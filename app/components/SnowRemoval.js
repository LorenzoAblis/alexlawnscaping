import "../styles/SnowRemoval.scss";

const SnowRemoval = () => {
  return (
    <section className="snow_removal-section" id="snow_removal">
      <div className="snow_removal-header">
        <h2>❄️🚜 &nbsp; Reliable and Affordable Snow Removal &nbsp; ❄️🚜</h2>
        <h5>
          ...
          if it snows on consecutive days, you'll receive a 50% discount on
          additional days because we understand the frustration of paying for a
          clean-up, only to have it snow again the next day!
        </h5>
      </div>
    </section>
  );
